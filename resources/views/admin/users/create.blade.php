        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::open(['route'=>'admin.users.store','method'=>'POST','id'=>'vendor_submit' ,'class'=>'forms-sample','files' => true]) !!}
                    <div class="row">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary"><i class="link-icon" data-feather="plus"></i> Add User</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
